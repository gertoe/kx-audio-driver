...
static __inline__ dword inpd_System(const io_port_t port, const word displacement){
    return inpd(port + displacement);
}

static __inline__ word inpw_System(const io_port_t port, const word displacement){
    return inpw(port + displacement);
}

static __inline__ byte inp_System(const io_port_t port, const word displacement){
    return inp(port + displacement);
}

static __inline__ void outpd_System(io_port_t port, const word displacement, const dword value){
    outpd(port + displacement, value);
}

static __inline__ void outpw_System(io_port_t port, const word displacement, const word value){
    outpw(port + displacement, value);
}

static __inline__ void outp_System(io_port_t port, const word displacement, const byte value){
    outp(port + displacement, value);
}
